...
sur la branch developpement. la branch developpement contenant les element récurent à toutes les pages. pour cela, sur la branch developpement j'ai taper dans le terminal. * git merge connect*
